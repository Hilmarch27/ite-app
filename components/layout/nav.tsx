...
import useCheckActiveNav from "@/hook/use-check-active-nav";
import { SideLink } from "@/types/side-link-types";
...
export default function Nav({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-red group border-b py-2 transition-[max-height,padding] duration-500 data-[collapsed=true]:py-2 md:border-none",
        className
      )}
    >
